...
async def fetch_book_from_open_library(isbn: str) -> Book | None:
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            return Book(authors=authors,isbn=isbn,pages=pages,title=title,year_released=publish_date,stock=0, synopsis="No Synopsis")
